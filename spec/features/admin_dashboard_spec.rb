...
#
#   xdescribe "admin dashboard feature" do
...
#   end
#
#   xdescribe "as a logged in user when I visit /admin/dashboard" do
...
#
#
#   xdescribe "as a visitor when I visit /admin/dashboard" do
#     it "I see a 404 error" do
#
#       visit admin_dashboard_path
#
